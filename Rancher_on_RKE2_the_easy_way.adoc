...
```bash
echo "RANCHER_CHART_VERSION="${RANCHER_CHART_VERSION}; echo "RANCHER_CHART_VERSION="${SET_DEVEL_FLAG}; echo "FQDN="${FQDN}; echo "TLS_SOURCE="${TLS_SOURCE}; echo "BOOTSTRAPPW="${BOOTSTRAPPW}
```
