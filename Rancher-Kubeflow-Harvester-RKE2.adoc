...
* Create the kubeflow namespace: `kubectl create namespace kubeflow`
...
* When finished with testing, delete the pod and service: `kubectl delete -f nginx-metallb-test.yaml`
