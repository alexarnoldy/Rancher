...
** Three VMs make up the HA control-plane and etcd pool:
...
* The open-iscsi software package was installed on all nodes
* The kernel-default-base kernel was replaced with kernel-default
...
.Install Longhorn CSI on Kubernetes cluster
